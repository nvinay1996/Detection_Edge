...
COMPONENT_FILES	:= address_counter.sv edge_detection.sv grayscale.sv AHB.sv edge_detection_core.sv mcu.sv buffer_window.sv buffer_2.sv  

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= Top_Level.sv
...
report_timing -path full -delay max -max_paths 1000 -nworst 1000 > reports/$(MOD_NAME).rep
