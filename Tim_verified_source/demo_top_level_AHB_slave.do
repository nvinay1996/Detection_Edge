...
add wave -noupdate -expand -group {Address 2} -radix hexadecimal /tb_Top_Level/DUT/AHB_DUT/II/boundary_4
add wave -noupdate -expand -group {Address 3} -radix hexadecimal /tb_Top_Level/DUT/AHB_DUT/II/start_waddr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Address Pipeline} {26393 ps} 1} {{Cursor 2} {25828 ps} 0}
