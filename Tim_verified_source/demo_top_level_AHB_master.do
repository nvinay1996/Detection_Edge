...
add wave -noupdate -divider {AHB Read Transfer}
add wave -noupdate /tb_Top_Level/tb_clk
add wave -noupdate /tb_Top_Level/tb_n_rst
add wave -noupdate -expand -group {Read Transfer} /tb_Top_Level/tb_clk
add wave -noupdate -expand -group {Read Transfer} -radix unsigned /tb_Top_Level/tb_m_haddr
...
add wave -noupdate -expand -group {HRDATA -> rgb} -radix hexadecimal /tb_Top_Level/tb_m_hrdata
add wave -noupdate -expand -group {HRDATA -> rgb} -radix hexadecimal /tb_Top_Level/DUT/rgb
add wave -noupdate -divider {AHB Write Transfer}
add wave -noupdate /tb_Top_Level/tb_clk
add wave -noupdate /tb_Top_Level/tb_n_rst
add wave -noupdate -group {Write Transfer} /tb_Top_Level/tb_clk
add wave -noupdate -group {Write Transfer} -radix unsigned /tb_Top_Level/tb_m_haddr
add wave -noupdate -group {Write Transfer} /tb_Top_Level/tb_m_hwrite
add wave -noupdate -group {Write Transfer} -radix hexadecimal /tb_Top_Level/tb_m_hwdata
add wave -noupdate -group {Write Transfer} /tb_Top_Level/tb_m_hready
add wave -noupdate /tb_Top_Level/tb_clk
add wave -noupdate -radix unsigned /tb_Top_Level/tb_m_haddr
add wave -noupdate /tb_Top_Level/tb_m_hwrite
add wave -noupdate -radix hexadecimal /tb_Top_Level/tb_m_hwdata
...
add wave -noupdate -expand -group {buffer2_data -> HWDATA} -radix hexadecimal /tb_Top_Level/tb_m_hwdata
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{READ 1} {60762 ps} 1} {{READ 2} {18132558101 ps} 1} {{WRITE 1} {3379418000 ps} 1}
...
update
WaveRestoreZoom {3379306364 ps} {3379812604 ps}
